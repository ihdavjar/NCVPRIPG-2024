...
class WPAL_res50(nn.Module):
    def __init__(self):
        super(WPAL_res50, self).__init__()
        ...
        return_layers = {'layer2':'out1', 'layer3':'out2', 'layer4':'out3'}
        self.backbone = torchvision.models._utils.IntermediateLayerGetter(model, return_layers)
        
        ## CONV1_E Head1
        self.Conv1_E = nn.Conv2d(512, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        self.fssp1_l1 = nn.AdaptiveMaxPool2d((1, 1))
        self.fssp1_l2 = nn.AdaptiveMaxPool2d((3, 3))
        self.FC1_E = nn.Linear(5120, 512)
        self.dr1 = nn.Dropout(0.5)

        ## CONV2_E Head2
        self.Conv2_E = nn.Conv2d(1024, 512, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))
        ...
        ## CONV3_E Head3
        self.Conv3_E = nn.Conv2d(2048, 1024, kernel_size=(3, 3), stride=(1, 1), padding=(1, 1))  
